...
<html lang="en">
  ...
  <body>
	  ...
	  <div class="container">
		  ...
		  <br /><br />
		  <h3>Last 10 servers</h3>
		  <?php
		  $results = mysqli_query($conn, "SELECT * FROM servers ORDER BY id DESC LIMIT 10");
			  ...
			  if( $results->num_rows !== 0 ) {
				 while($rowitem = mysqli_fetch_array($results)) {
					...
					echo "<td>" . $rowitem['pterodactyl_serverid'] . "</td>";
					echo "<td>" . '<a href="deleteserver?id=' . $rowitem['pterodactyl_serverid'] . '" class="btn btn-danger" role="button">Delete</a> &nbsp; <button type="button" class="btn btn-info" data-toggle="modal" data-target="#changeram" onclick="document.getElementById(\'changeram_serverid\').value=\'' . $rowitem['pterodactyl_serverid'] . '\'">Change RAM</button> &nbsp; <button type="button" class="btn btn-info" data-toggle="modal" data-target="#changedisk" onclick="document.getElementById(\'changedisk_serverid\').value=\'' . $rowitem['pterodactyl_serverid'] . '\'">Change Disk</button> &nbsp; <button type="button" class="btn btn-info" data-toggle="modal" data-target="#changecores" onclick="document.getElementById(\'changecores_serverid\').value=\'' . $rowitem['pterodactyl_serverid'] . '\'">Change Cores</button>' . "</td>";
					echo "</tr>";
				}
			  } else {
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
				...
				New server RAM (in MB): <input type="number" name="newram" class="form-control" min="128" value="128"><br />
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
				...
				New server disk space (in MB): <input type="number" name="newdisk" class="form-control" min="128" value="128"><br />
	...
	<!-- modal:changecores -->
	<div id="changecores" class="modal fade" role="dialog">
	  <div class="modal-dialog">

		<!-- Modal content-->
		<div class="modal-content">
		  <div class="modal-header">
			<h4 class="modal-title">Change Server Cores</h4>
		  </div>
		  <div class="modal-body">
				<form action="changecores" method="get">
				<input type="hidden" name="id" id="changecores_serverid" class="form-control">
				New server cores: <input type="number" name="newcores" class="form-control" min="1" value="1"><br />
				<input type="submit" value="Change Cores" class="btn btn-success">
				</form>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
