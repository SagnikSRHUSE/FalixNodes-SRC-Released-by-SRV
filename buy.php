...
if( $_GET['method'] == "paypal" ) {
	...
	<form action="https://falixnodes.host/safepaypal/widget.php" method="post" name="buyform" id="buyform">

		<input type="hidden" name="item_name" value="FalixNodes: Plan">

		<input type="hidden" name="item_price" value="' . $level_info['price'] . '">
